...
<body> 
	...
	<p style="text-align: center;"><span style="background-color: #000000; color: #000000;"><strong>LAPORAN PEMASUKAN </strong></span></p>
	...
	<table class="table mb-none"> 
		...
		<tbody> @foreach ($barang_keluars as $item) <tr> 
			...
			<h5>Total Barang Masuk : 
				{{$barang_keluars->sum('kuantitas')}}  	
			</h5>
			<h5>Total Uang Masuk : 
				Rp. {{number_format($barang_keluars->sum('total'),'2',',','.')}}
			</h5>
</body> 
</html>
